import type { GreenDealFormState } from "./greenDealTypes";

export const GREEN_DEAL_INSTALLER_DIRECTORY = [
  { name: "David McVernon", id: "S0606150" },
] as const;

export function createDefaultGreenDealForm(): GreenDealFormState {
  return {
    ...
    installationEmail: "",
    installationPhone: "",
    installerName: GREEN_DEAL_INSTALLER_DIRECTORY[0].name,
    installerId: GREEN_DEAL_INSTALLER_DIRECTORY[0].id,
    designerName: "",
    electricianName: "",
