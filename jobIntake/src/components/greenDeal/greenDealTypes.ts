/** GreenDeal-only form model; evolve independently from BridgeSelect. */
export type GreenDealFileValue = File | File[] | null;

export interface GreenDealFormState {
  jobType: string;
  ownerType: string;
  jobCategory: string;
  ...
  electricityBill: GreenDealFileValue;
  ...
  signedProject: GreenDealFileValue;
  solarProposal: GreenDealFileValue;
  uploadElectricityBill: GreenDealFileValue;
  sitePhotos: GreenDealFileValue;
  supportingDocuments: GreenDealFileValue;
}
...
export type GreenDealStringFieldKey = KeysByType<GreenDealFormState, string>;
export type GreenDealBooleanFieldKey = KeysByType<GreenDealFormState, boolean>;
export type GreenDealFileFieldKey = KeysByType<GreenDealFormState, GreenDealFileValue>;
export type GreenDealFormErrors = Partial<Record<GreenDealStringFieldKey, string>>;
export type GreenDealSuggestibleFieldKey = Exclude<keyof GreenDealFormState, GreenDealFileFieldKey>;
